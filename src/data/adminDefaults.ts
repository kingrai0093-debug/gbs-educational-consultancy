...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  newsSourceName: "NepalLive.com & News24 Nepal",
...
export const DEFAULT_NEWS_TICKER: NewsTickerItem[] = [
  ...
  },
  {
    ...
    titleNepali: "नेपाली विद्यार्थीहरूका लागि १००% सम्मको GKS तथा विश्वविद्यालय मेरिट छात्रवृत्ति उपलब्ध",
    badge: "🎓 SCHOLARSHIP",
  ...
  },
  {
    ...
    titleNepali: "नेपालस्थित कोरियाली राजदूतावास: विद्यार्थी भिसा कागजात प्रमाणीकरण सम्बन्धी नयाँ निर्देशिका",
    ...
    sourcePortalUrl: "https://np.mofa.go.kr/np-en/brd/m_25533/list.do",
    date: "Latest Notice",
    isActive: true,
    urgency: "notice",
  },
  {
    ...
    titleNepali: "कोरियामा विद्यार्थी न्यूनतम पारिश्रमिक प्रतिघण्टा १०,०३० कोरियन वोन (~रु. १,०००) पुग्यो",
    badge: "💼 WORK RIGHTS",
  ...
  },
  {
    ...
    titleNepali: "साल्यान हाउस बागबजारमा निःशुल्क परामर्श तथा TOPIK १/२ तयारी कक्षा उपलब्ध",
    badge: "📍 BAGBAZAR HUB",
